...
<link href="<c:url value="css/seeHomeworksByStudentCss.css" />"
	rel="stylesheet">
				...
				<tbody class="wrapword">
					<c:forEach var="homework"
						...
						<tr>
							...
							<td><c:set var="passesOn"
									value="${fn:replace(homework.closingTime,'T', ' ')}" /> <c:if
									test="${homework.daysLeft ge 0}">
