...
public class TestDAO {
	...
	public void test18addSolutionToTask() throws UserException {
		...
		UserDAO.getInstance().setSolutionOfTask(hd.getId(), user1.getId(), 0, "my_solution.java",
	...
	public void test24updateGroup() throws GroupException, UserException, ValidationException {
		...
		ArrayList<Teacher> currTeachersInUpdatedGroup = GroupDAO.getInstance()
		...
		ArrayList<Teacher> currTeachersInUpdatedGroup1 = GroupDAO.getInstance()
