...
public class LoginFilter implements Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws ServletException, IOException {    
        ...
        System.out.println("STATUSSSSS: " + response.getStatus());
        String loginURI5 = request.getContextPath() + "/indexReturn";
		...
		if (loggedIn || loginRequest || loginRequest2 || loginRequest1 || loginRequest5) {
