...
public class SessionListener implements HttpSessionListener {
	...
	public void sessionCreated(HttpSessionEvent event) {
		...
		System.out.println(
				"A new session is created " + LocalDateTime.now() + "id of session: " + event.getSession().getId());
	}

	@Override
	public void sessionDestroyed(HttpSessionEvent event) {
		System.out.println(
				"session is destroyed " + LocalDateTime.now() + "id of session: " + event.getSession().getId());
	}
